...
func (r *RequestOptions) ToHeader() http.Header {
	...
	} else if r.AccessTokenFunc != nil {
		if token, err := r.AccessTokenFunc(); err == nil && token != "" {
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/aadi-labs/agenttrunk-plugins/sdk/go")
	headers.Set("X-Fern-SDK-Version", "v0.1.0")
	headers.Set("User-Agent", "github.com/aadi-labs/agenttrunk-plugins/sdk/go/0.1.0")
	return headers
}
