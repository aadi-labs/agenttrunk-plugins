...
class HttpClient:
    ...
    def request(
        ...
        *,
        ...
        try:
            response = bounded_request(self.httpx_client,
                method=method,
                url=_request_url,
    ...
    def stream(
        ...
        *,
        ...
        with bounded_stream(self.httpx_client,
            method=method,
            url=_request_url,
            headers=_request_headers,
            params=_encoded_params if _encoded_params else None,
...
class AsyncHttpClient:
    ...
    async def request(
        ...
        *,
        ...
        try:
            response = await async_bounded_request(self.httpx_client,
                method=method,
                url=_request_url,
                headers=_request_headers,
                params=_encoded_params if _encoded_params else None,
    ...
    async def stream(
        ...
        *,
        ...
        async with async_bounded_stream(self.httpx_client,
            method=method,
            url=_request_url,
            headers=_request_headers,
            params=_encoded_params if _encoded_params else None,
