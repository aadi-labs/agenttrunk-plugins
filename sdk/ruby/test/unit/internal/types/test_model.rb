...
describe AgentTrunk::Internal::Types::Model do
  ...
  class ExampleModel < AgentTrunk::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < AgentTrunk::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < AgentTrunk::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < AgentTrunk::Internal::Types::Model
