...
describe AgentTrunk::Internal::Types::Union do
  class Rectangle < AgentTrunk::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < AgentTrunk::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < AgentTrunk::Internal::Types::Model
