...
describe AgentTrunk::Internal::Types::Utils do
  Utils = AgentTrunk::Internal::Types::Utils

  module TestUtils
    class M < AgentTrunk::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < AgentTrunk::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < AgentTrunk::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = AgentTrunk::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { AgentTrunk::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises AgentTrunk::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = AgentTrunk::Internal::Types::Array[String]
      ModelArray = -> { AgentTrunk::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { AgentTrunk::Internal::Types::Array[TestUtils::U] }
