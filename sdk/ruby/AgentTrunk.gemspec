...
require_relative "lib/AgentTrunk/version"
...
Gem::Specification.new do |spec|
  spec.name = "agenttrunk"
  spec.authors = ["AgentTrunk"]
  spec.version = AgentTrunk::VERSION
  spec.summary = "Ruby client library for the AgentTrunk API"
  spec.description = "The AgentTrunk Ruby library provides convenient access to the AgentTrunk API from Ruby."
