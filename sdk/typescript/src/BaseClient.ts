...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.AgentTrunkEnvironment | string>;
    ...
    /** The default number of times to retry the request. Defaults to 0; mutations are never retried. */
    maxRetries?: number;
...
export interface BaseRequestOptions {
    ...
    timeoutInSeconds?: number;
    /** The number of times to retry the request. Defaults to 0; mutations are never retried. */
    maxRetries?: number;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@agenttrunk/sdk",
            "X-Fern-SDK-Version": "0.1.0",
            "User-Agent": "@agenttrunk/sdk/0.1.0",
