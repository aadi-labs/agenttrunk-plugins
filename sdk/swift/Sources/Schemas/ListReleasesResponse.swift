...
public struct ListReleasesResponse: Codable, Hashable, Sendable {
    public let data: [PromotionRequest]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try container.decode([PromotionRequest].self, forKey: .data)
