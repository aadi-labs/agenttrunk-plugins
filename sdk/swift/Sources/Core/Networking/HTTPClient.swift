...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw AgentTrunkError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw AgentTrunkError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                let (data, response) = try await AgentTrunkSafety.data(for: request, session: clientConfig.urlSession)
                ...
                let clientError: AgentTrunkError?
                ...
                } else if let existingClientError = error as? AgentTrunkError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw AgentTrunkError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> AgentTrunkError
    {
        ...
        return AgentTrunkError.httpError(httpError)
    }
}
