...
Use the generated Go client from the [public repository](https://github.com/aadi-labs/agenttrunk-plugins/tree/main/sdk/go).
...
[Publishing](/publishing) · [Release review](/releases) · [Generated reference](https://github.com/aadi-labs/agenttrunk-plugins/blob/main/sdk/go/reference.md)
