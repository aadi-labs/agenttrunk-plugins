...
Use the generated Ruby client from the [public repository](https://github.com/aadi-labs/agenttrunk-plugins/tree/main/sdk/ruby).
...
[Publishing](/publishing) · [Release review](/releases) · [Generated reference](https://github.com/aadi-labs/agenttrunk-plugins/blob/main/sdk/ruby/reference.md)
