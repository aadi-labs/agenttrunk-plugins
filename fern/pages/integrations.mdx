...
The [quickstart](https://docs.agenttrunk.ai/quickstart) builds the CLI from source and connects it through human approval. Use it from a terminal-capable agent or automation.
...
Use [operational MCP](/guides/mcp) at `https://api.agenttrunk.ai/mcp` with securely supplied bearer credentials, or use the CLI, SDK and REST interfaces.
